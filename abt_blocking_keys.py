...
df1 = pd.read_parquet(f"./data/Abt_embedded_minhash_all.pqt")
df2 = pd.read_parquet(f"./data/Buy_embedded_minhash_all.pqt")
gold_standard = pd.read_csv("./data/truth_abt_buy.csv", sep=",", encoding="utf-8", keep_default_na=False)
