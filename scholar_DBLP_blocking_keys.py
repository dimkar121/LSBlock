...
df2 = pd.read_parquet(f"./data/Scholar_embedded_minhash_all.pqt")
df1 = pd.read_parquet(f"./data/DBLP2_embedded_minhash_all.pqt")
gold_standard = pd.read_csv("./data/truth_Scholar_DBLP.csv", sep=",", encoding="utf-8", keep_default_na=False)
